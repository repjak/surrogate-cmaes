...
%% DEFINING CALLBACK FUNCTIONS
    ...
    function selectDataX(~,~,~)
        ...
        handles.settings.datafilex = strcat(filepath,filename);
        guidata(gcbo, handles); 
    end
    ...
    function selectDataY(~,~,~)
        ...
        handles.settings.datafiley = strcat(filepath,filename);
        guidata(gcbo, handles);
    end
    ...
    function selectTestDataX(~,~,~)
        ...
        handles.settings.testdatafilex = strcat(filepath,filename);
        guidata(gcbo, handles);
    end
    ...
    function selectTestDataY(~,~,~)
        ...
        handles.settings.testdatafiley = strcat(filepath,filename);
        guidata(gcbo, handles);  
    end
