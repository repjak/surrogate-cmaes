exp_id = 'exp_doubleEC_ord_01';
exp_description = 'Surrogate CMA-ES model, ordinal GP, doubly-trained EC, 24 functions, 15 instances, 2, 3, 5D';
...
surrogateParams = { ...
  ...
  'evoControlRestrictedParam', { 0.05, 0.1 }, ...
};
