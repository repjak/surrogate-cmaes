exp_id = 'exp_geneEC_adapt_15_kendall_10D';
exp_description = 'Surrogate CMA-ES model using generation EC with generation number dependant on model''s Kendall error, best settings, ardmatern52';
