exp_id = 'exp_geneEC_adapt_11_kl_sym_12fun_10D';
exp_description = 'Surrogate CMA-ES model using generation EC with generation number dependant on model''s symmetric KullbackLeibler divergence on 12 functions, ardmatern52, gpml';
