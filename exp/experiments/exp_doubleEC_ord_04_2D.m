exp_id = 'exp_doubleEC_ord_04_2D';
exp_description = 'Surrogate CMA-ES model, ordinal GP, covSE, logcluser, unipoints, doubly-trained EC, 24 functions, 15 instances, 2D';
