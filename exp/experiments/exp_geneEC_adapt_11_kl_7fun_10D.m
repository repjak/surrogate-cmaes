...
exp_description = 'Surrogate CMA-ES model using generation EC with generation number dependant on model''s KullbackLeibler divergence on 12 functions, ardmatern52';
