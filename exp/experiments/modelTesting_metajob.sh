...
#
echo '##############'
echo Will be called: $MATLAB -nodisplay -singleCompThread -r "func=[$FUNC]; dims=[$DIM]; ${MATLAB_FCN}";
echo '##############'

$MATLAB -nodisplay -singleCompThread -r "func=[$FUNC]; dims=[$DIM]; ${MATLAB_FCN}";
#
########################
