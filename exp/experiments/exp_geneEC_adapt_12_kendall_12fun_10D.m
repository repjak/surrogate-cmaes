exp_id = 'exp_geneEC_adapt_12_kendall_12fun_10D';
exp_description = 'Surrogate CMA-ES model using generation EC with generation number dependant on model''s Kendall error on 12 functions, ardmatern52, gpml';
