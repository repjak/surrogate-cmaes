exp_id = 'exp_gpop_10_10D';
exp_description = 'GPOP (Buche) with GP and CMA-ES, all functions, 15 instances, 100 * dim maxfunevals, one task per instance. Training method according to article';
...
surrogateParams = { ...
  ...
  'gpop_prtb',               { 1 }, ...               % perturbation coeficient
  'gpop_logModulo',          { 1 }, ...               % log state every iteration
};
