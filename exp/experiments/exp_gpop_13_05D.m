exp_id = 'exp_gpop_13_05D';
exp_description = 'GPOP (Buche) with GP and CMA-ES, 2 funs, 2 instances, 100 * dim maxfunevals, compare various cov fcns, sigma and sets of hyperparameters';
...
bbobParams = { ...
  ...
  'instances',               { [1 41] }, ...     % default is [1:5, 41:50]
  'maxfunevals',             { '100 * dim' }, ...
};
...
modelParams = { ...
  'cov',                     { struct( ...
                                 'fcn', 'ardsquaredexponential', ...
                                 'sigma', 'sqrt((1 - 1e-3)/2)', ...
                                 'hyp', '[(10 - 1e-2)/2 * ones(dim, 1); sqrt((1 - 1e-3)/2)]' ... % ell, signal variance
                               ), ...
							   struct( ...
                                 'fcn', 'ardsquaredexponential', ...
                                 'hyp', '[(10 - 1e-2)/2 * ones(dim, 1); sqrt((1 - 1e-3)/2)]' ...
                               ), ...
                               struct( ...
                                 'fcn', 'ardsquaredexponential', ...
                                 'sigma', 'sqrt((1 - 1e-3)/2)' ...
                               ...
                               struct( ...                                                       % settings we used with gpml
                                 'fcn', '@covFcn', ...
                                 'sigma', 0.001, ...
                                 'hyp', 'log([0.5 * ones(dim, 1); 0.1; 0.01; 1e-4])' ...
                               ), ...
                               struct( ...
                                 'fcn', '@covFcn', ...
                                 'sigma', 0.01, ...
