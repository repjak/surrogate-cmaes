exp_id = 'exp_gpop_09_05D';
exp_description = 'GPOP (Buche) with GP and CMA-ES, Sphere, Rastrigin, Rosenbrock, 2 instances, 100 * dim maxfunevals, one task per instance. Training method according to article';
...
surrogateParams = { ...
  ...
  'gpop_maxIterPrtb',        { 1 }, ...              % maximum number of consecutive perturbations
