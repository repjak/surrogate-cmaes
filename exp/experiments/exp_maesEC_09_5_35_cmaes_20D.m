exp_id = 'exp_maesEC_09_5_35_cmaes_20D';
exp_description = 'Model Assisted Evolution Strategy (Ulmer, 2003), GP model, (5,35) CMA-ES, 3*lambda pre-selection, 2*lambda training points, POI or mean prediction, 24 functions, 15 instances, orig covfcn, gpml, 250D evals';
