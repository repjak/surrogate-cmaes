exp_id = 'exp_geneEC_adapt_13_rankdiff_7fun_10D';
exp_description = 'Surrogate CMA-ES model using generation EC with generation number dependant on model''s RankDiff error on 7 functions, ardmatern52';
