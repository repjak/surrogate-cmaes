function overallLik = compareOrdGpModels(modelOptions, dataset, comp_model, outputFolder, saveIter)
% overallLik = compareOrdGpModels(modelOptions, dataset, comp_model, 
