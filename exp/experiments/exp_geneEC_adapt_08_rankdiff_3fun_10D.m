exp_id = 'exp_geneEC_adapt_08_rankdiff_3fun_10D';
exp_description = 'Surrogate CMA-ES model using generation EC with generation number dependant on model''s RankDiff error, functions 13, 17, 21';
