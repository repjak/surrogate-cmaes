exp_id = 'exp_restrEC_02_sd2_gp20z';
exp_description = 'Surrogate CMA-ES model using restricted individual EC with sd2 criterion and GPs with possibly zero-mean mean function, in 5D';
...
bbParamDef(5).values = {'100 * dim'};   % increment maxfunevals successively
