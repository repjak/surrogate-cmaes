exp_id = 'exp_geneEC_adapt_09_kl_7fun_10D';
exp_description = 'Surrogate CMA-ES model using generation EC with generation number dependant on model''s KullbackLeibler divergence on 7 functions';
