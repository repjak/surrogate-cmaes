exp_id = 'exp_doubleEC_ord_04_2D_none';
exp_description = 'Surrogate CMA-ES model, ordinal GP, covSE, no clustering, doubly-trained EC, 24 functions, 15 instances, 2D';
