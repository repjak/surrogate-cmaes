exp_id = 'exp_doubleEC_ord_05_2D';
exp_description = 'Surrogate CMA-ES model, ordinal GP, covSE, logcluser, unipoints, doubly-trained EC, 24 functions, 15 instances, 2D, (source code revised)';
