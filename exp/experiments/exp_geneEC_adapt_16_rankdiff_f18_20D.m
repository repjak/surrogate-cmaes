exp_id = 'exp_geneEC_adapt_16_rankdiff_f18_20D';
exp_description = 'Surrogate CMA-ES model using generation EC with generation number dependant on model''s RankDiff error, best settings, ardmatern52';
