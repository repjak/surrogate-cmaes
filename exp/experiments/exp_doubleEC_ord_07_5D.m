exp_id = 'exp_doubleEC_ord_07_5D';
exp_description = 'Surrogate CMA-ES model, ordinal GP, covSE, [unipoints, logcluster, none] binning, doubly-trained EC, 24 functions, 15 instances, 2D, 3D, 5D, (source code revised)';
