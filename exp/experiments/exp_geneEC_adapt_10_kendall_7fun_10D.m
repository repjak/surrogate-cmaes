exp_id = 'exp_geneEC_adapt_10_kendall_7fun_10D';
exp_description = 'Surrogate CMA-ES model using generation EC with generation number dependant on model''s Kendall error';
